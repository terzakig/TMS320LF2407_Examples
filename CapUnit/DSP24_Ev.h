...
extern volatile unsigned int *T2CNT; // Timer 2 Counter Register
extern volatile unsigned int *T2PR; // Timer 2 Period Register
extern volatile unsigned int *T2CMPR; // Timer 2 Compare register
