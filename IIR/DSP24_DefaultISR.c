...
interrupt void T1PINT_ISR(void) {
 ...
 switch(PLState) {
     case 0: // change T1 compare to 600 (pulse length 2.1 msec)
			 PLState ++;
			 *T1CMPR = 600;
			 break;
	 case 1: // change T1 compare to 47000 (pulse length 50 usec)
	         PLState++;
			 *T1CMPR = 47200;
			 break;
	 case 2: // change T1 compare back to 500 (pulse length 2.375 msec)
	         PLState = 0;
			 *T1CMPR = 500;
			 break;
	} 
