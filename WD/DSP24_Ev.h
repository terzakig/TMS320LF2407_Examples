...
extern volatile unsigned int *T3CNT;   /* GP timer 1 counter reg */
extern volatile unsigned int *T3CMPR;   /* GP timer 1 compare reg */
extern volatile unsigned int *T3PR;   /* GP timer 1 period */
