...
void initIO(void) {
  ...
  MCRAbits->bit.T1PWMT1CMP_GPIOB4=0; // T1CMP pin set as regular I/O
  
  // setting up PWM1 and PWM2 for Pulse Width Modulation
  MCRAbits->bit.PWM1_GPIOA6 = 1;
  MCRAbits->bit.PWM2_GPIOA7 = 1;
 }  
